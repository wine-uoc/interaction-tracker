...
'''
Recoger datos a diferentes distancias para calibrar

-MODIFICAR DIST
-MODIFICAR LAUNCHPAD_NAME
-SELECCIONAR NUM_SAMPLES POR EJECUCIÓN
-Los datos se guardan en la carpeta Data_Collection/dataCollected
...
# CONSTANTES
NUM_SAMPLES = 100    # numero de muestras por cada locator y posicion (x,y)
DIST = 400          # en centimetros
LAUNCHPAD_NAME = "LAUNCH1"  #puede ser LAUNCH1, LAUNCH2 o LAUNCH3
...
def initialize_DS():
    ...
    while i < len(SP_NAMES):
        ...
        lp_info['json_filename'] = 'detectedDevs_' + SP_NAMES[i] + '_' + str(DIST) + '_cm' + '_.json'
