 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /home/aaron/Universidad/TFG/Software-v2/ccs-workspace-ok-ok/simple_observer_cc2640r2lp_app_timestamp/FlashROM_StackLibrary/configPkg/package/cfg/app_ble_pem3");
