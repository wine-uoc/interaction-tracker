 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /home/aaron/Trabajo/interaction-tracker-updated/ccs-workspace-ok-ok/simple_observer_cc2640r2lp_app_Trabajo/FlashROM_StackLibrary/configPkg/package/cfg/app_ble_pem3");
