 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /home/aaron/Documentos/Trabajo/ccs-workspace/simple_broadcaster_cc2640r2lp_app/FlashROM_StackLibrary/configPkg/package/cfg/app_ble_pem3");
